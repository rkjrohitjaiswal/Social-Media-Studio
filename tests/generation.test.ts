...
import { buildGenerationPrompt, executeSingleJob } from "../apps/api/src/integrations/ai/generation.js";
import { OpenAIImageProvider, ProviderError, detectImageMimeType } from "../apps/api/src/integrations/ai/provider.js";
import {
  createGenerationRun,
  retrySingleJobInRun,
...
vi.mock("../apps/api/src/config/supabase.js", () => ({
