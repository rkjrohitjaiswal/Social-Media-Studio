...
import { validateCampaignAssetFile } from "@/lib/validations/campaign";
  ...
  const uploadSelectedFiles = async (currentItems: BulkUploadItem[]) => {
    ...
    for (const item of pendingItems) {
      ...
      try {
        ...
        const capabilityRes = await fetch(`/api/campaigns/${campaignId}/assets/upload-url`, {
          method: "POST",
        ...
        const completeRes = await fetch(`/api/campaigns/${campaignId}/assets/complete`, {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
